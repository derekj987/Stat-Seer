...
export type NcaafScoring = { off: number; def: number; g: number; offRank: number; defRank: number };
...
export const NCAAF_SCORING: Record<string, NcaafScoring> = NCAAF_MODEL.context.scoring;
