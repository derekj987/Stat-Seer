...
def main():
    ...
    # The Card: line-blind projections for the upcoming week, using next season's
    # carryover rating (regressed end-of-`last` rating) — the model's preseason read.
    prior_next = {t: DECAY * r for t, r in final.items()}
    card_games = project_week(DB, prior_next, hfa, CARD_SEASON, CARD_WEEK, CARD_LIMIT)
